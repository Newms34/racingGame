...
router.use('/track',require('./subroutes/tracks'))
...
router.get('/edit', function(req, res, next) {
    /*get mobile!*/
    res.sendFile('mapEdit.html', { root: './views' })
});
router.get('/create', function(req, res, next) {
    /*get mobile!*/
    res.sendFile('createRace.html', { root: './views' })
});
router.get('/join', function(req, res, next) {
    /*get mobile!*/
    res.sendFile('joinRace.html', { root: './views' })
});
